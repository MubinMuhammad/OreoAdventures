...
void gameEngine::textureCropAtlas(cstmEngine::vec2 *out_coord1, cstmEngine::vec2 *out_coord2,
...
void gameEngine::textureGetCoords(std::vector<cstmEngine::vec2> &texGrid, int idx,
